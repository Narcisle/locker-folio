        ...
        <article className="idc__card">
            ...
            <div className="idc__body">
              <div className="idc__photo">
                <img
                  ...
                  src="/assets/avatar/avatar-512.webp"
                  srcSet="/assets/avatar/avatar-256.webp 256w, /assets/avatar/avatar-512.webp 512w"
                  sizes="158px"
                  alt="徐诗怡头像"
                  loading="lazy"
                  decoding="async"
          ...
          <div className="idc__lower">
            ...
            <div className="idc__tag" aria-hidden>
              <span className="idc__tagTop">HUAQIAO</span>
              <span className="idc__tagBody">ENGLISH '23</span>
            </div>
          </div>
