...
const NotesCarousel = lazy(() => import('../work/NotesCarousel'))
const AccountsView = lazy(() => import('../work/AccountsView'))
...
const POS: Record<string, { l: number; t: number; w: number; h: number; rot: number }> = {
  ...
  internship: { l: 56.8, t: 63.5, w: 22.3, h: 31.8, rot: 2 },
  accounts: { l: 12.5, t: 8.5, w: 20.5, h: 30, rot: -4 },
}
  ...
  if (workView) {
    return (
      <Suspense fallback={<div className="wv wv--loading" />}>
        ...
        {workView === 'internship' && <NotesCarousel />}
        {workView === 'accounts' && <AccountsView />}
      </Suspense>
    )
  }
